    ...
    <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('projects.update', ['user' =>Auth::id(), 'project' => $project->id]) }}">
                            @csrf
                            @method('PATCH')
                            ...
                            @foreach($developers as $developer)
                                <div class="form-group row col-md-8 m-auto">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="developers[]" value="{{$developer->id}}"  {{ $users->find($developer->id) != null ? "checked" : "" }}>
